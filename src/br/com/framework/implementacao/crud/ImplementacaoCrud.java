...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	public void persist(T obj) throws Exception {
	 ...
	 @Override 
	    ...
	    return lista; //aula implementação crud parte3 min 12:33
	 ...
	 @Override 
	  ...
	  @Override public List<T> findListByQueryDinamica(String s) throws Exception {
	  ...
	  public Long totalRegistro(String table) throws Exception {
		...
		public Query obterQuery(String query) throws Exception {
			 validaSessionFactory();
		     Query queryReturn = sessionFactory.getCurrentSession().createQuery(query.toString()); // aula implementação crud parte 04 min 13:47
		     
		     return queryReturn;
		}
	 
	  
	    @Override public List<T> findListByQueryDinamica(String query, int iniciaNoRegistro, int maximoResultado) throws Exception {
	...
	private void validaSessionFactory() {
		...
		validaTransaction(); // ta na aula implementação crud parte 02 min07:50
	}
